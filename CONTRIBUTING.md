...
This project and everyone participating in it is governed by the [Okta Code of Conduct](https://github.com/okta/samples-aspnetcore/tree/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to developers@okta.com.
