...
updateConfig(path.join(__dirname, '../..', 'federated-okta-hosted', '/dist/okta-aspnetcore-mvc-example/appsettings.json'));
updateConfig(path.join(__dirname, '../..', 'self-hosted', '/dist/okta-aspnetcore-mvc-example/appsettings.json'));
